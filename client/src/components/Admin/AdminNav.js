// import styles "../../assets/css/admin.module.css";

// const AdminNav = ({ styles }) => {
//   return (
...
//           <li className={styles.tooltipElement} data-tooltip="0">
//             <a href="./index.html" className={styles.active} data-active="0">
//               <div className={styles.icon}>
//                 <i className="bx bx-tachometer"></i>
//                 <i className="bx bxs-tachometer"></i>
//               </div>
//               <span className={`${styles.link} ${styles.hide}`}>Dashboard</span>
//             </a>
//           </li>
...
//               </div>
//               <span className={`${styles.link} ${styles.hide}`}>Projects</span>
//             </a>
//           </li>

//           <li className={styles.tooltipElement} data-tooltip="3">
//             <a href="./blogs.html" data-active="3">
//               <div className={styles.icon}>
//                 <i className="bx bx-bar-chart-square"></i>
//                 <i className="bx bxs-bar-chart-square"></i>
//               </div>
//               <span className={`${styles.link} ${styles.hide}`}>Blogs</span>
//             </a>
//           </li>
//           <li className={styles.tooltipElement} data-tooltip="4">
//             <a href="./forms.html" data-active="4">
//               <div className={styles.icon}>
//                 <i className="bx bx-bar-chart-square"></i>
//                 <i className="bx bxs-bar-chart-square"></i>
//               </div>
//               <span className={`${styles.link} ${styles.hide}`}>Forms</span>
//             </a>
//           </li>
...
//         <a
//           href="#"
//           className={`${styles.account} ${styles.tooltipElement}`}
//           data-tooltip="0"
//         >
//           <i className="bx bx-user"></i>
//         </a>
//         <div
//           className={`${styles.adminUser} ${styles.tooltipElement}`}
//           data-tooltip="0"
//         >
//           <div className={`${styles.adminProfile} ${styles.hide}`}>
//             <img
...
//         </div>
//         <div className={styles.tooltip}>
//           <span className={styles.show}>John Doe</span>
//           <span>Logout</span>
//         </div>
//       </div>
//     </nav>
